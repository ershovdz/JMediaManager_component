...
define('JMM_PHP_XML', class_exists( 'CJmmSimpleXMLElement' ) && ( version_compare( phpversion(), '5.1.3', '>=' ) ) && ( ! @ini_get( 'zend.ze1_compatibility_mode' ) ) && ! defined('JMM_XML_TEST') );

if ( JMM_PHP_XML ) {
	jmmimport( 'jmm.xml.xml' );
} else {
	jmmimport( 'jmm.xml.domit' );
}
 ...
 *
 */
class CJmmSimpleXMLElement extends FixedSimpleXML 
{
	/**
	 ...
	 * @return  CJmmSimpleXMLElement  or false if no child matches
	 */
